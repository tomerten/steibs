...
void STE_ReadInput::setDipoleBendingRadius( std::string k, float v)
{
...
// set RF voltage 1
void STE_ReadInput::setRFVoltageV1( std::string k, float v )
{
	if (k=="RFVoltage1") 
	{
		inputMapFloat[k] = v;
...
// set RF voltage 2
void STE_ReadInput::setRFVoltageV2( std::string k, float v )
{
	if (k=="RFVoltage2") 
	{
		inputMapFloat[k] = v;
...
// set RF voltage 3
void STE_ReadInput::setRFVoltageV3( std::string k, float v )
{
	if (k=="RFVoltage3") 
	{
		inputMapFloat[k] = v;
...
void STE_ReadInput::setHarmonicNumber1( std::string k, float v )
{
...
void STE_ReadInput::setHarmonicNumber2( std::string k, float v )
{
...
void STE_ReadInput::setHarmonicNumber3( std::string k, float v )
{
...
void STE_ReadInput::setBetatronCoupling( std::string k, float v )
{
...
void STE_ReadInput::setk2l( std::string k, float v )
{
	if (k=="k2l") 
	{
		if (v == 0.0)
...
void STE_ReadInput::setk2sl( std::string k, float v )
{
	if (k=="k2sl") 
	{
		if (v == 0.0)
...
void STE_ReadInput::setRFmix( std::string k , float v)
{
	if (k=="RFmix") 
	{
		if (v == 0.0)
...
void STE_ReadInput::setcoulomblog( std::string k , float v)
{
	if (k=="coulomblog") 
	{
		if (v == 0.0)
...
void STE_ReadInput::setibsCoupling( std::string k , float v)
{
	if (k=="ibsCoupling") 
	{
		if (v == 0.0)
...
void STE_ReadInput::setibsfrac( std::string k , float v)
{
	if (k=="fracibstot") 
	{
		if (v == 0.0)
...
** ***************************
**/ 
float STE_ReadInput::getRFVoltageV1()
{
	return inputMapFloat["RFVoltage1"];
}

float STE_ReadInput::getRFVoltageV2()
{
	return inputMapFloat["RFVoltage2"];
}

float STE_ReadInput::getRFVoltageV3()
{
	return inputMapFloat["RFVoltage3"];
}


float STE_ReadInput::getHarmonicNumber1()
{
	return inputMapFloat["HarmonicNumber1"];
}

float STE_ReadInput::getHarmonicNumber2()
{
	return inputMapFloat["HarmonicNumber2"];
}

float STE_ReadInput::getHarmonicNumber3()
{
	return inputMapFloat["HarmonicNumber3"];
}
...
float STE_ReadInput::getDipoleBendingRadius()
{
	return inputMapFloat["dipoleBendingRadius"];
}
...
float STE_ReadInput::getBetatronCoupling()
{
	return inputMapFloat["betatronCoupling"];
}

float STE_ReadInput::getk2l()
{
	return inputMapFloat["k2l"];
}

float STE_ReadInput::getk2sl()
{
	return inputMapFloat["k2sl"];
}
...
float STE_ReadInput::getRFmix()
{
	return inputMapFloat["RFmix"];
}
...
float STE_ReadInput::getcoulomblog()
{
	return inputMapFloat["coulomblog"];
}

float STE_ReadInput::getibsCoupling()
{
	return inputMapFloat["ibsCoupling"];
}

float STE_ReadInput::getibsfrac()
{
	return inputMapFloat["fracibstot"];
}
...
void STE_ReadInput::ReadInput()
{
	...
	if (inputfile.good())
	{
		...
		if ( iss >> key >> valueFloat )
		{
			// std::cout << key << valueInt << std::endl;
			setDipoleBendingRadius(key, valueFloat);
		}
		else
		{
		...
		{
			// std::cout << key << valueInt << std::endl;
			setHarmonicNumber1(key, valueFloat);
		}
		else
		{
		...
		{
			// std::cout << key << valueInt << std::endl;
			setHarmonicNumber2(key, valueFloat);
		}
		else
		{
		...
		{
			// std::cout << key << valueInt << std::endl;
			setHarmonicNumber3(key, valueFloat);
		}
		else
		{
		...
		{
			// std::cout << key << valueInt << std::endl;
			setBetatronCoupling(key, valueFloat);
		}
		else
		{
...
void STE_ReadInput::PrintInput()
{
	...
	// printing the float maps
	for(std::map<std::string,float>::iterator mif = inputMapFloat.begin(); mif != inputMapFloat.end(); mif++)
	{
