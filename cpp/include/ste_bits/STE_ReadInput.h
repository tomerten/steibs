...
public:
	...
	void setDipoleBendingRadius( std::string , float );
	float getDipoleBendingRadius();

	void setRFVoltageV1( std::string , float );
	void setRFVoltageV2( std::string , float );
	void setRFVoltageV3( std::string , float );

	void setHarmonicNumber1( std::string, float );
	void setHarmonicNumber2( std::string, float );
	void setHarmonicNumber3( std::string, float );


	float getRFVoltageV1();
	float getRFVoltageV2();
	float getRFVoltageV3();

	float getHarmonicNumber1();
	float getHarmonicNumber2();
	float getHarmonicNumber3();
	...
	void setBetatronCoupling( std::string, float );
	float getBetatronCoupling();

	void setk2l( std::string, float );
	float getk2l();

	void setk2sl( std::string, float );
	float getk2sl();
	...
	void setibsCoupling( std::string, float );
	float getibsCoupling();

	void setibsfrac( std::string , float );
	float getibsfrac();
	...
	void setRFmix( std::string , float );
	float getRFmix();
	...
	void setcoulomblog( std::string , float );
	float getcoulomblog();
...
private:
	...
	std::map<std::string,float> inputMapFloat;
